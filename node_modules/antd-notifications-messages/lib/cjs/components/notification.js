...
var antdIcons_1 = require("./antdIcons");
var Notification = function (_a) {
    ...
    return (React.createElement("div", { className: "ant-notification-notice " + (animation === 'fadeInRight' ? 'elementTopRight' : 'elementTopFadeIn') + " " + className },
        React.createElement("div", { className: "icon-notification icon-" + type },
            React.createElement(antdIcons_1.AntdIcon, __assign({ type: type }, rest))),
        ...
        React.createElement("div", { className: "notification-close", onClick: function () { return utils_1.store.remove(id); } })));
};
