...
var newText = function (text) { return ({ key: "".concat(Date.now()), data: text }); };
var TextTransition = function (_a) {
    ...
    var transitions = (0, react_spring_1.useTransition)([content], {
        from: { opacity: 0, transform: "translateY(".concat(direction === "down" ? "-100%" : "100%", ")") },
        enter: { opacity: 1, transform: "translateY(0%)" },
        leave: { opacity: 0, transform: "translateY(".concat(direction === "down" ? "100%" : "-100%", ")") },
        keys: function (item) { return item.key; },
        config: springConfig,
    ...
    var animatedProps = (0, react_spring_1.useSpring)({
        to: width,
        config: springConfig,
        immediate: isFirstRun,
    });
    ...
    return (React.createElement(react_spring_1.animated.div, { className: "text-transition ".concat(className), style: __assign(__assign(__assign({}, animatedProps), { whiteSpace: inline ? "nowrap" : "normal", display: inline ? "inline-block" : "block", position: "relative" }), style) },
        ...
        React.createElement("div", { className: "text-transition_inner", style: {
                ...
                height: "100%",
                width: "100%"
            } }, transitions(function (styles, item) { return (React.createElement(react_spring_1.animated.div, { style: __assign(__assign({}, styles), { position: "absolute" }) }, item.data)); }))));
};
